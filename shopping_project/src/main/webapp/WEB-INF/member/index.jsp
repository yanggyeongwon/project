    ...
    <section>
        ...
        <div class="menu">
            <div id="logo">
                ...
                <div class="join">
                    <a id="basket" href="#"><span>장바구니</span><img src="images/basket.png" alt="no"></a>
        ...
        <div id="main_image">
            <div id="images" >
                ...
                <img src="images/main22.jpg" alt="main_image2">
                <img src="images/main33.jpg" alt="main_image3">
                <img src="images/main44.jpg" alt="main_image4">
                <img src="images/main55.jpg" alt="main_image5">
                <img src="images/main66.jpg" alt="main_image6">
                <img src="images/main77.jpg" alt="main_image7">
            </div>
        </div>
        <div id="main2_image">
            <div class="area1">
                ...
                <div class="product_items">
                    <div class="images_show" id="best">
                        <img src="images/best2.jpg" alt="no">
                        <p>BEST</p>
                    </div>
                    <div class="images_show" id="top">
                        <img src="images/top.jpg" alt="no">
                        <p>TOP</p>
                    </div>
                    <div class="images_show" id="pants">
                        <img src="images/pants.jpg" alt="no">
                        <p>PANTS</p>
                    </div>
                    <div class="images_show" id="outer">
                        <img src="images/outer.jpg" alt="no">
                        <p>OUTER</p>
                    </div>
                    <div class="images_show" id="shoes">
                        <img src="images/shoes.jpg" alt="no">
                        <p>SHOES</p>
                    </div>
                </div>
            </div>
            <div class="area2">
                ...
                <div class="product_items">
                    <div class="bottom_product">
                        <img src="images/best.jpg" alt="no">
