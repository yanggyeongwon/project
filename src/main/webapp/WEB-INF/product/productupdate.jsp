	            ...
	            <div id="second_box">
	                 	...
	                 	<div id="right_box">
	                        <div id="text_box">
	                            ...
	                            <ul id="flex_ck1">
	                                <li class="margin-left7"><input type="checkbox" name="pssize" value="240" <c:if test="${fn:contains(product.pssize,'240' )}">checked</c:if>></li>
	                                <li class="margin-left7"><input type="checkbox" name="pssize" value="250" <c:if test="${fn:contains(product.pssize,'250' )}">checked</c:if>></li>
	                                <li class="margin-left7"><input type="checkbox" name="pssize" value="260" <c:if test="${fn:contains(product.pssize,'260' )}">checked</c:if>></li>
	                                <li class="margin-left7"><input type="checkbox" name="pssize" value="270" <c:if test="${fn:contains(product.pssize,'270' )}">checked</c:if>></li>
	                                <li class="margin-left7"><input type="checkbox" name="pssize" value="280" <c:if test="${fn:contains(product.pssize,'280' )}">checked</c:if>></li>
	                            </ul>
	                            <ul class="flex_ul">
